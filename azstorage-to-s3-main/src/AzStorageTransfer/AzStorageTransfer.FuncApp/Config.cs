...
namespace AzStorageTransfer.FuncApp
{
    public static class Config
    {
        ...
        public static class Aws
        {
            ...
            public static RegionEndpoint Region { get; } = RegionEndpoint.GetBySystemName(Environment.GetEnvironmentVariable("AwsRegion") ?? RegionEndpoint.APNortheast1.SystemName);
        }
    }
}